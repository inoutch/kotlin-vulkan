...
import vulkan_ios.VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO

@ExperimentalUnsignedTypes
fun VkPipelineDynamicStateCreateInfo.copyToNative(
    native: vulkan_ios.VkPipelineDynamicStateCreateInfo,
    scope: MemScope
) {
...
fun VkPipelineDynamicStateCreateInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_ios.VkPipelineDynamicStateCreateInfo>()
