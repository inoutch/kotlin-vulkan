...
fun VkPipelineColorBlendAttachmentState.copyToNative(native: vulkan_ios.VkPipelineColorBlendAttachmentState) {
...
fun VkPipelineColorBlendAttachmentState.toNative(scope: MemScope) =
        scope.alloc<vulkan_ios.VkPipelineColorBlendAttachmentState>()
                .also { copyToNative(it) }.ptr

@ExperimentalUnsignedTypes
fun List<VkPipelineColorBlendAttachmentState>.toNative(scope: MemScope) =
        scope.allocArray<vulkan_ios.VkPipelineColorBlendAttachmentState>(size)
