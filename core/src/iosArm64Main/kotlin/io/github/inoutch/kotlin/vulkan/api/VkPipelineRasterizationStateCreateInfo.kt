...
import vulkan_ios.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO

@ExperimentalUnsignedTypes
fun VkPipelineRasterizationStateCreateInfo.copyToNative(native: vulkan_ios.VkPipelineRasterizationStateCreateInfo) {
...
fun VkPipelineRasterizationStateCreateInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_ios.VkPipelineRasterizationStateCreateInfo>()
