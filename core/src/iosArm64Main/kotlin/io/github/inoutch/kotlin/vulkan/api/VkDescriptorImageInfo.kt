...
fun VkDescriptorImageInfo.copyToNative(native: vulkan_ios.VkDescriptorImageInfo) {
...
fun List<VkDescriptorImageInfo>.toNative(scope: MemScope) =
        if (isEmpty()) null else scope.allocArray<vulkan_ios.VkDescriptorImageInfo>(size)
