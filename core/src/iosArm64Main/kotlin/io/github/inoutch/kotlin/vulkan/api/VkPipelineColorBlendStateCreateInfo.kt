...
import vulkan_ios.VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO

@ExperimentalUnsignedTypes
fun VkPipelineColorBlendStateCreateInfo.copyToNative(
    native: vulkan_ios.VkPipelineColorBlendStateCreateInfo,
    scope: MemScope
) {
...
fun VkPipelineColorBlendStateCreateInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_ios.VkPipelineColorBlendStateCreateInfo>()
