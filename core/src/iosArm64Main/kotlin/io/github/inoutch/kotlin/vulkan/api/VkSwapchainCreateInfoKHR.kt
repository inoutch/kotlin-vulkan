...
import vulkan_ios.VK_STRUCTURE_TYPE_SWAPCHAIN_CREATE_INFO_KHR

@ExperimentalUnsignedTypes
fun VkSwapchainCreateInfoKHR.copyToNative(
    native: vulkan_ios.VkSwapchainCreateInfoKHR,
    scope: MemScope
) {
...
fun VkSwapchainCreateInfoKHR.toNative(scope: MemScope) =
        scope.alloc<vulkan_ios.VkSwapchainCreateInfoKHR>()
