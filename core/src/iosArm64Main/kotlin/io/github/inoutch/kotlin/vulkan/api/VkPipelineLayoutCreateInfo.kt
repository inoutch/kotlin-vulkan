...
import vulkan_ios.VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO

@ExperimentalUnsignedTypes
fun VkPipelineLayoutCreateInfo.copyToNative(
    native: vulkan_ios.VkPipelineLayoutCreateInfo,
    scope: MemScope
) {
...
fun VkPipelineLayoutCreateInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_ios.VkPipelineLayoutCreateInfo>()
