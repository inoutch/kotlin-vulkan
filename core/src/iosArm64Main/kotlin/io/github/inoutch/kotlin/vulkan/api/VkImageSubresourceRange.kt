...
fun VkImageSubresourceRange.copyToNative(native: vulkan_ios.VkImageSubresourceRange) {
...
fun List<VkImageSubresourceRange>.toNative(scope: MemScope) =
        if (isEmpty()) null else scope.allocArray<vulkan_ios.VkImageSubresourceRange>(size)
