...
fun VkInstanceCreateInfo.copyToNative(
    native: vulkan_android.VkInstanceCreateInfo,
    scope: MemScope
) {
    native.sType = vulkan_android.VK_STRUCTURE_TYPE_INSTANCE_CREATE_INFO
    native.pNext = null
...
fun VkInstanceCreateInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_android.VkInstanceCreateInfo>().also { copyToNative(it, scope) }.ptr
