...
import vulkan_android.VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER

@ExperimentalUnsignedTypes
fun VkImageMemoryBarrier.copyToNative(native: vulkan_android.VkImageMemoryBarrier) {
...
fun List<VkImageMemoryBarrier>.toNative(scope: MemScope) =
        scope.allocArray<vulkan_android.VkImageMemoryBarrier>(size)
