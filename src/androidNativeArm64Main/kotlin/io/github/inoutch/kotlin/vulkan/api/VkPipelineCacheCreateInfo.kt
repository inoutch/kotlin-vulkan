...
import vulkan_android.VK_STRUCTURE_TYPE_PIPELINE_CACHE_CREATE_INFO

@ExperimentalUnsignedTypes
fun VkPipelineCacheCreateInfo.copyToNative(
    native: vulkan_android.VkPipelineCacheCreateInfo,
    scope: MemScope
) {
...
fun VkPipelineCacheCreateInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_android.VkPipelineCacheCreateInfo>()
