...
import vulkan_android.VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO

@ExperimentalUnsignedTypes
fun VkPipelineViewportStateCreateInfo.copyToNative(
    native: vulkan_android.VkPipelineViewportStateCreateInfo,
    scope: MemScope
) {
...
fun VkPipelineViewportStateCreateInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_android.VkPipelineViewportStateCreateInfo>()
