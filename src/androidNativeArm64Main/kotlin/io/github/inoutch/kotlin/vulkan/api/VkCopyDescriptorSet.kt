...
import vulkan_android.VK_STRUCTURE_TYPE_COPY_DESCRIPTOR_SET

@ExperimentalUnsignedTypes
fun VkCopyDescriptorSet.copyToNative(native: vulkan_android.VkCopyDescriptorSet) {
...
fun List<VkCopyDescriptorSet>.toNative(scope: MemScope) =
        if (isEmpty()) null else scope.allocArray<vulkan_android.VkCopyDescriptorSet>(size)
