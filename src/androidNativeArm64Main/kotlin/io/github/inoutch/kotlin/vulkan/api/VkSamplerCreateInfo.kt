...
import vulkan_android.VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO

@ExperimentalUnsignedTypes
fun VkSamplerCreateInfo.copyToNative(native: vulkan_android.VkSamplerCreateInfo) {
...
fun VkSamplerCreateInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_android.VkSamplerCreateInfo>()
