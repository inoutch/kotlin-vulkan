...
import vulkan_android.VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO

@ExperimentalUnsignedTypes
fun VkDeviceCreateInfo.copyToNative(
    native: vulkan_android.VkDeviceCreateInfo,
    scope: MemScope
) {
...
fun VkDeviceCreateInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_android.VkDeviceCreateInfo>().also { copyToNative(it, scope) }.ptr
