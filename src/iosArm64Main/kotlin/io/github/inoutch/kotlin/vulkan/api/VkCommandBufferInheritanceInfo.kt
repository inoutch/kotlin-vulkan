...
import vulkan_ios.VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_INFO

@ExperimentalUnsignedTypes
fun VkCommandBufferInheritanceInfo.copyToNative(native: vulkan_ios.VkCommandBufferInheritanceInfo) {
...
fun VkCommandBufferInheritanceInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_ios.VkCommandBufferInheritanceInfo>().also { copyToNative(it) }.ptr
