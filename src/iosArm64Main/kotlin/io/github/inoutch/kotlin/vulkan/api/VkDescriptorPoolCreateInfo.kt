...
import vulkan_ios.VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO

@ExperimentalUnsignedTypes
fun VkDescriptorPoolCreateInfo.copyToNative(
    native: vulkan_ios.VkDescriptorPoolCreateInfo,
    scope: MemScope
) {
...
fun VkDescriptorPoolCreateInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_ios.VkDescriptorPoolCreateInfo>()
