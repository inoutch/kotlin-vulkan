...
import vulkan_ios.VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO

@ExperimentalUnsignedTypes
fun VkRenderPassCreateInfo.copyToNative(
    native: vulkan_ios.VkRenderPassCreateInfo,
    scope: MemScope
) {
...
fun VkRenderPassCreateInfo.toNative(scope: MemScope) =
        scope.alloc<vulkan_ios.VkRenderPassCreateInfo>().also { copyToNative(it, scope) }.ptr
